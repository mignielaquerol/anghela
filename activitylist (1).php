...
<div class="navbar" style="background-color: #040454; color: white; text-align: right; padding: 10px;">
    ...
    <div class="row">
        <div class="col-md-7">
            ...
            <div class="col-md-12">
            <a href="activities.php" class="btn btn-success" style="border-radius: 15px; background-color: green; padding: 5px 5px; font-size: 15px; text-transform: uppercase; letter-spacing: 1px; color: white;">
    <i class="fas fa-plus-circle" style="margin-right: 10px;"></i> Add Activity
    </a>
